...
router.post('/:id/solutions', authMiddleware_1.authMiddleware, (0, roleMiddleware_1.requireRole)('admin'), ticketValidators_1.createSolutionValidators, ticketValidators_1.validate, solutionController_1.createSolution);
