...
router.get('/archived', authMiddleware_1.authMiddleware, ticketController_1.getArchivedTickets);
...
router.post('/:id/assign/:specialistId', authMiddleware_1.authMiddleware, (0, roleMiddleware_1.requireRole)('admin', 'specialist'), assignmentController_1.assignSpecialist);
router.delete('/:id/assign/:specialistId', authMiddleware_1.authMiddleware, (0, roleMiddleware_1.requireRole)('admin', 'specialist'), assignmentController_1.removeAssignment);
router.post('/:id/feedback', authMiddleware_1.authMiddleware, feedbackController_1.addFeedback);
